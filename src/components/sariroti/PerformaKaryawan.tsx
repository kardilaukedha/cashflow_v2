  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Performa Karyawan</h2>
          <p className="text-sm text-gray-500">Analisis kinerja karyawan Sari Roti per bulan</p>
        </div>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <span className="text-sm text-gray-500">{rows.length} karyawan aktif</span>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {rows.map((row, i) => {
            ...
            return (
              <div key={row.user_profile_id} className="bg-white rounded-xl border border-gray-200 p-4">
                ...
                <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="bg-gray-50 rounded-lg p-2.5">
                    ...
                    <p className="font-bold text-gray-800">{row.total_checkins}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-2.5">
                    <div className="flex items-center gap-1 mb-0.5">
                    ...
                    <p className="font-bold text-gray-800 text-sm">Rp {Number(row.total_billing).toLocaleString('id-ID')}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-2.5">
                    <div className="flex items-center gap-1 mb-0.5">
                      <TrendingUp className="w-3 h-3 text-purple-500" />
                      <span className="text-xs text-gray-500">Hari Plan Dibuat</span>
                    </div>
                    <p className="font-bold text-gray-800">{row.total_plans} hari</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-2.5">
                    <div className="flex items-center gap-1 mb-0.5">
